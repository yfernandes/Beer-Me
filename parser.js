...
var Recipe = /** @class */ (function () {
    function Recipe(RecipeFileLocation) {
        var FILE = parser.parse(fs.readFileSync(RecipeFileLocation, 'utf8'));
        var RECIPE = FILE.RECIPES.RECIPE;
        ...
        this.Hops = [];
        for (var i = 0; i < RECIPE.HOPS.HOP.length; i++) {
            this.Hops.push({
        ...
        this.Fermentables = [];
        for (var i = 0; i < RECIPE.FERMENTABLES.FERMENTABLE.length; i++) {
        ...
        this.Misc = [];
        for (var i = 0; i < RECIPE.MISCS.MISC.length; i++) {
            this.Misc.push({
        ...
        var aux = [];
        for (var i = 0; i < RECIPE.MASH.MASH_STEPS.MASH_STEP.length; i++) {
            aux.push({
...
var myRecipe = new Recipe('./Recipe/recipe.xml');
